...
<html>
  ...
  <body>
    ...
    <img class="rotate_image" src="" id="photo" >
    <table>
...
void setup() {
  ...
  //tega ni treba softAP(const char *ssid, const char *password, int channel, int ssid_hidden, int max_connection);
  startCameraServer();
